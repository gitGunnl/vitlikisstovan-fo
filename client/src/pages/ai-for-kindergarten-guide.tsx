 ...
 * Samansjóðingar (integratiónir) ella sjálvvirkni. Henda vegleiðing er bert til kjatt (avrita/líma).
 ...
 Ein einføld regla: Um ein fremmandur persónur kann eyðmerkja eitt fólk út frá tí, tú skrivar inn, skalt tú ikki leggja tað í kjattið.

 Hugsa um eitt postkort, ikki eitt afturlatið bræv. Almenn vitlíkisamboð kunnu eisini samanberast við eina útvarpssending: tá ið tað er sagt, er tað úti. Alt sum tú skrivar inn í kjattið endar hjá ánaranum av amboðnum, t.d. hjá fyritøkuni OpenAI, um tú brúkar ChatGPT. Eins og at alt sum vit skriva á Messenger ella Facebook, endar hjá fyritøkuni Meta. Tá vit ikki skriva nakað slag av persónligum dátum inn, er hetta ikki ein trupulleiki. Brúka tískil bert almenna ella navnleysa kunning og tøl, uttan so at tú ert heilt vís/ur í, at tú ert á eini góðkendari skipan hjá arbeiðsgevaranum.
 ...
 * Hevur arbeiðsgevari tín váttað eina góðkenda vitlíkis-skipan til persónsdátur á skrift? Um nei → ger tað navnleyst ella lat vera við at seta inn.
 ...
 - "Búfólk B (80-árini) hevði eitt fall í felagsrúminum seint fyrrapartin. Rólig eftir fyrstuhjálp og vanliga pínustillandi sambært ætlan; verður eygleitt." (Tú tillagar orðingina seinni í tíni almennu skipan).
 ...
 * Umsetingar ella samandráttir, sum fevna um nágreiniligar sjúkrasøgur ella persónligar umstøður.
 ...
 Gott ráð: Goym eitt notat við lýsing av tínum vanliga arbeiðsumhvørvi (t.d. bólkastødd, førleikar, tøkt tilfar, høli og støð, sum tit ofta vitja), sum tú lættliga kanst seta inn í vitlíkis-kjattið. Hetta hjálpir tær at fáa skjótari og betri tillagað úrslit hvørja ferð.
 ...
 * Handverkaravitjanir: Fyrireika ein skjótan lista til, tá ið hvs-maður ella elektrikari kemur á vitjan. Hann kann fevna um áminningar um at verja privatlívið hjá búfólkum, rudda atgongd, tryggja trygdina og rudda upp eftir vitjanina.
 ...
 Stílur: Einfalt, nevtralt, eingi nøvn ella persónligir smálutir (brúka "Búfólk A/B"). Vinarliga spyr fyrst, um okkurt er ógreitt.
 ...
 * Áminning um kvittanir: Send skjótar, vinaligar áminningar um at savna kvittanir inn, so smáar umsitingarligar uppgávur verða lættari.
 ...
 Byrt: Eg eri í Klaksvík við 5 vaksnum búfólkum (blandaðir førleikar). Klokkan er 14:00–14:30, beint eftir at vaskimaskinan er liðug (turkitrumlan hurrar \\\~14:05, gongshurðin hvínur). Vit hava eitt lítið borð, mjúkar blýantar, A4 pappír og spælikort.
 ...
 * stutt notat, sum forklarar "hví hetta róar"
 ...
 Byrt: Í dag í Tórshavn er okkara goymsluskáp læst til klokkan 10:45. Nú er klokkan 10:15–10:40, og vit hava bara stólar tøkar (eitt borð er ov vaggut at brúka). Plássið er avmarkað, so virksemið má vera sitandi ella ógvuliga einfalt.
 ...
 * uppskot til at falla til ró skjótt (30–60 sek)
 ...
 Byrt: Eg eri einsamallur/einsamøll í Runavík (Stova 3N, ógvuliga lítið pláss, 3,5×4 m). Atgongd við koyristóli er avmarkað, fólk ganga framvið 5\\. hvønn minutt, og tað er ein stutt brandávaringar-roynd (floyt) kl. 10:00. Okkum tørvar tvey varin sitandi rørsluvirksemis uppskot (8–10 min hvørt).
 ...
 * greiða "steðgiorð" leiðbeining
 ...
 Byrt: Vit eru í Vestmanna og hava ein 20-minuttir matar-/kaffi-steðg (11:20–11:40) við sólríka vindeygað. Tað er fyrsta kavafrost í hesi vikuni; ferju-floytan ljóðar umleið 12:15. Vit vildu fegin havt einføld, varin samrøðu-upplegg um "Veður & Árstíðir."
 ...
 Byrt: Í morgin fara vit í bygdarparkina í Sandavági (13:10–14:20). Forsøgnin sigur vind og eitt sindur av regni, og gøtur nærhendis bonkum kunnu vera hálar. Vit eru 4 búfólk (blandað flytføri) \\+ 2 starvsfólk, brúka hýruvogn (heinting 13:05, kortgjalding er ynskilig).
 ...
 * Í hýruvogninum
 ...
 Byrt: Vit eru júst komin aftur (\\\~11:30) frá einum innkeypstúri á Tvøroyri. Eg havi leysar kvittanir, ein posa, sum ikki er pakkaður út, hýruvogns-smálutir at logga, eitt næstan fult køliskáp, og ómerktar leivdir.
 ...
 * stutt (2-min) eftirmetingar-notat
 ...
 Byrt: Vit hava okkara vikuliga innkeypstúr í Norðragøtu (týsdag, 10:15–11:15 við bussi). Fíggjarkarmurin er 700 kr, og goymslupláss (køliskáp/frystiboks/turr) er lítið. Húsreglur: hav altíð laktosufría mjólk og nøtufrítt (snarl) …hvat er hetta “SNARL”??? tøkt.
 ...
 * Gott at hava (Maks 12 vørur íalt, við uml. nøgdum \+ 2 bíligum alternatium)
 ...
 Byrt: Vit fáa vitjan av elektrikara í tekøkinum í Sørvági í dag millum 14:00–16:00. Atgongd er gjøgnum bakhurðina (gólvið kann vera vátt, um tað regnar). Ketilsikringin slær lættliga frá. Búfólk kunnu ganga ígjøgnum eftir te.
 ...
 * EFTIR (4–5 punkt)
 ...
 Byrt: Vit hava eina vitjan á heilsumiðstøðini í Tórshavn hendan mikumorgunin (09:30–11:00). Møtistaður er forhøllin við teir bláu stólarnar; hýruvognsbílegging er váttað. Knakar har verða skjótt fullir.
 ...
 ## Tak greitt við: møtistað, tíðarbil, og ting at taka við (jakka, kort um neyðugt). Brúka óheftan/nevtralan tóna, eingi nøvn – brúka "Búfólk A/B". Ongar persónligar dátur. 
 ...
 Byrt: Tað er vorðið kaldari í Klaksvík. Vit vilja fegin seta eina almenna, vinarliga áminning á familjutalvuna.
